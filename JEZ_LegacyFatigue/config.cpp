// config.bin - 21:33:05 12/19/15, generated in 0.73 seconds
...
class CfgPatches {
	class JEZ_LegacyFatigue {
		...
		requiredAddons[] = {"A3_Anims_F", "A3_Characters_F", A3_UI_F};
	};
};
...
class CfgFunctions {
	class JEZ_LegacyFatigue {
		...
		class Misc {
			class legacyFatigue {
				file = "A3\JEZ_LegacyFatigue\Functions\Misc\fn_legacyFatigue.sqf";
			};
		};
	};
};
...
class CfgMovesBasic {
	...
	class HealBase;	// External class reference
	class HealBaseRfl;	// External class reference
	class DefaultDie;	// External class reference
	class StandBase;	// External class reference
	class AgonyBase;	// External class reference
	class AgonyBaseRfl;	// External class reference
...
class CfgMovesMaleSdr : CfgMovesBasic {
	class States {
		...
		class Acts_InjuredLyingRifle02 : CutSceneAnimationBaseZoZo {
			stamina = 0.8;
		};
...
class cfgMods {
	author = 76561197993335740;
	timepacked = 1450173644;
};
